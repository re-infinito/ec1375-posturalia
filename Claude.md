...
recursos.html             "Tutoriales y toolkit" (17 sep, sidebar → Recursos): toolkit de formatos para el consultorio (PDF + Word)
                           que se desbloquea al terminar el proceso — ver "Recursos: toolkit profesional" en Cambios recientes
...
- **Navegación entre secciones y declaraciones del candidato** (plan `docs/superpowers/plans/2026-09-17-navegacion-y-declaraciones.md`, spec `…/specs/2026-09-17-recursos-navegacion-declaraciones-design.md`, partes A y D; C toolkit abajo; B tutoriales pendiente):
