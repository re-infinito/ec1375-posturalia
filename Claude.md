...
- **Navegación entre secciones y declaraciones del candidato** (plan `docs/superpowers/plans/2026-09-17-navegacion-y-declaraciones.md`, spec `…/specs/2026-09-17-recursos-navegacion-declaraciones-design.md`, partes A y D; B tutoriales y C toolkit siguen pendientes):
